...
exports.run = (client, message, args) => {
  ...
  .setDescription(`sen burda bu komutu kullanamazsın!.`)
  ...
  const embed = new Discord.RichEmbed()
    ...
    .addField('Verilen Rol:', `${yetki}`)
    .addField('Rol Verilen Kullanıcı:', `${user.username}#${user.discriminator} (${user.id})`)
    .addField('Rol Veren Yetkili:', `${message.author.username}#${message.author.discriminator}`)
